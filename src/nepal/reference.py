...
def add_arguments(ap: argparse.ArgumentParser) -> None:
    """Register this tool's flags on a parser owned by the CLI."""
...
def run(cfg, args) -> int:
    """Fetch the reference datasets. ``cfg`` is a loaded Config."""
...
def main(argv: list[str] | None = None) -> int:
    """Standalone entry point, for use before the package is installed."""
